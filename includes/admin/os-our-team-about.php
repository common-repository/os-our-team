...
if ( ! class_exists( 'OS_About' ) ) :
	...
	class OS_About { 
		...
		public function __construct() { 
			...
			add_action( 'admin_menu', array( $this, 'os_our_team_admin_menu' ) );
		}
		...
		public function os_our_team_admin_menu() {
			
			add_submenu_page( 'edit.php?post_type=os-our-team', __( 'About Offshorent', OT_TEXT_DOMAIN ), __( 'About', OT_TEXT_DOMAIN ), 'manage_options', 'about-os-out-team-developer', array( $this, 'about_our_team_developer' ) );
		}
